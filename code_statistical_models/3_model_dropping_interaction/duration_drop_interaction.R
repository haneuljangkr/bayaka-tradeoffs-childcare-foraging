...
d$n_earlyC <- as.numeric(scale(d$n_earlyC))
d$n_middleC <- as.numeric(scale(d$n_middleC))
d$n_adolescent <- as.numeric(scale(d$n_adolescent))
...
d1 <- d1 %>%
  ...
  summarise(
    ...
    avg_num_earlyC = mean(n_earlyC, na.rm = T),
    avg_num_middleC = mean(n_middleC, na.rm = T),
    avg_num_adolescent = mean(n_adolescent, na.rm = T)) %>%
  ...
  mutate(
    ...
    n_earlyC_c = n_earlyC - avg_num_earlyC,
    n_middleC_c = n_middleC - avg_num_middleC,
    n_adolescent_c = n_adolescent - avg_num_adolescent,
